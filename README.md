...
在 nonebot2 项目的根目录下打开命令行, 输入以下指令即可安装
    ...
    nb plugin install nonebot-plugin-group-relay
...
<summary>pip</summary>
    ...
    pip install nonebot-plugin-group-relay
</details>
...
| 指令 | 权限 | 需要@ | 范围 | 说明 |
|:-----:|:----:|:----:|:----:|:----:|
| `/开启群聊监听` | 群管理员/主人 | 是 | 群聊 | 在当前群开启消息转发功能，本群的普通消息会被转发到已配置的目标群。 |
| `/关闭群聊监听` | 群管理员/主人 | 是 | 群聊 | 在当前群关闭消息转发功能，停止向目标群转发本群消息。 |
| `/添加监听群组 <群号>` | 群管理员/主人 | 是 | 群聊 | 为当前群添加一个目标群，用于接收本群转发的消息。示例：`/添加监听群组 123456789` |
| `/删除监听群组 <群号>` | 群管理员/主人 | 是 | 群聊 | 从当前群的目标群列表中移除一个群。示例：`/删除监听群组 123456789` |
